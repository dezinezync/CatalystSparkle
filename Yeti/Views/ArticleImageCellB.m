...
NSString *const kiPadArticleImageCell = @"com.yeti.cell.iPadArticleImageCell";

@interface ArticleImageCellB ()
...
@implementation ArticleImageCellB
...
- (void)setupAppearance {
    ...
    BOOL isAccessibilityContentCategory = _IsAccessibilityContentCategory();
...
- (void)configure:(FeedItem *)item customFeed:(FeedType)feedType sizeCache:(nonnull NSMutableDictionary *)sizeCache {
    ...
    if (feedType != FeedTypeFeed) {
        ...
        if (_IsAccessibilityContentCategory()) {
