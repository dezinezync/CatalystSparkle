...
HTMLUtils *MyHTMLUtils;

@interface HTMLUtils ()

@property (nonatomic, strong) NSDictionary <NSString *, NSString *>* characterEntities;
...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        // from https://github.com/raspu/Highlightr/blob/master/Pod/Classes/HTMLUtils.swift
        self.characterEntities = @{@"&quot;"     : @"\"",
                                   @"&amp;"      : @"&",
                                   @"&apos;"     : @"'",
                                   @"&lt;"       : @"<",
                                   @"&gt;"       : @">",
...
- (char)decode:(NSString *)string numeric:(UInt32)base
{
    ...
    char code = strtoul(chars, nil, base);
    return code;
}
