...
@objc public final class CoalescingQueue: NSObject {
    ...
    @objc public static let standard = CoalescingQueue(name: "Standard", interval: 0.05, maxInterval: 0.1)
    ...
    @objc public func add(_ target: AnyObject, _ selector: Selector) {
    ...
    @objc public func performCallsImmediately() {
