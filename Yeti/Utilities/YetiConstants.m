...
NSString * const kHideBars = @"com.dezinezync.elytra.hideBars";
...
BOOL canSupportOLED (void) {
    NSSet *const OLEDiPhones = [NSSet setWithObjects:@"iPhone10,3", @"iPhone10,6", @"iPhone11,4", @"iPhone11,2", @"iPhone11,6", @"iPhone12,3",@"iPhone12,5", nil];
